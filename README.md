...
1. How would you describe acessibility on the web to someone new to programming?
   ...
   Is your website acessible to everybody. meaning can someone who has trouble seeing or using a screen reader able to follow and understand your web site.

2. Talk about 3 different things you can do to ensure your website is accessible.

   Use Semantic html to markup your webpage. Use alt tags to describe images. Use colour contrast between text and background.

3. How would you explain the concept of a variable to someone new to programming?

   A variable is a name at a value is assigned. If i give a variable the name num and assign it 1. that is saying you want the value at the address of num;

4. What is the purpose of using functions in code?

   To help us write and organize more complex pieces of code.artist
