...
function get20s(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    let born = parseInt(yearsArr[0]);
    let died = parseInt(yearsArr[1]);
...
console.log(
  addArtist(
    ...
    "student",
    "American",
    "Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto aut aliquid praesentium blanditiis alias similique nihil sequi repellat distinctio officia at corporis neque molestias ea debitis, sint velit. Laborum, ad?"
  )
);
